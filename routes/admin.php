...
Route::group(['as' => 'dispatcher.', 'prefix' => 'dispatcher'], function () {
    ...
    Route::resource('insurance', 'Resource\InsuranceResource');
    ...
    Route::resource('sub_category', 'Resource\SubCategoryResource');
    Route::resource('category', 'Resource\CategoryResource');
    Route::resource('selling', 'Resource\SellingResource');

    Route::resource('membership', 'Resource\MembershipResource');

    Route::get('getSubCategories', 'Resource\ServiceResource@getSubCategories');
    Route::get('getSubCategoriesTwo', 'Resource\ServiceResource@getSubCategoriesTwo');
