                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="incoming-img bg-img" id="user-image" style={{ backgroundImage: 'url(' + "http://instacabtest.97pixels.com/storage/app/public/"+this.props.request.user.picture + ')' }}></div>
...
class TripAwaitingButton extends React.Component {
    render() {
        return (
            <div>
...
class TripComponent extends React.Component {
    ...
    getButtons() {
        switch(this.props.request.status) {
			...
			case "AWAITING": 
                return (
                    <TripAwaitingButton submit={this._submit.bind(this)} />
                );
                break;
