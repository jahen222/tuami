...
class RegisterController extends Controller
{
  ...
  //           $provider_service_name = 'CAR';
		...
		$Provider['vehicle_id'] = $data['provider_type'];
		$Provider['vehicle_plate_no'] = $data['vehicle_no'];
		$Provider['vehicle_model'] =	$data['vehicle_model'];
		...
		// 	"provider_service_type" 	=>	$data['provider_type'],
  ...
  //       ];
		...
		// $checkd = AccountSwitch::where('provider_service_type',$data['provider_type'])->where('provider_id',$Provider->id)->first();
