...
class Provider extends Authenticatable
{
 ...
 'available_to', 'currency_id', 'base_amount','provider_service_type','major_service_type_id','lang','term_n','vehicle_id',
        'vehicle_plate_no',
        'vehicle_model'
    ];
     ...
     */
    protected $hidden = [
        'password', 'remember_token', 'updated_at','last_name',
    ];
    ...
    {
        return $this->hasOne('App\ProviderBookmarks')->where('user_id',\Auth::id());
    }
