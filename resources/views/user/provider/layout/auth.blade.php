...
<footer>
            <div class="container">
                ...
                <img src="http://carecrew.97pixels.com/public/uploads/fdb8af397d97040bf67bc8fba67cf614db254afc.png" width="60%" height="60%" />
            </div>
                    </div>
                    <div class="col-md-4 footer-signup">    
                        <div class="footer-topbtn">
                        <a href="/PassengerSignin" class="btn btn-default">SIGN UP TO Request</a>
            </div>
                    </div>
                    <div class="col-md-4 footer-becomedriver">
                        <div class="footer-topbtn border">
                        <a href="{{ url('/provider/register') }}" class="btn btn-default">Become a care taker</a>
            </div>
                    </div>
                </div>
                </div>
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <ul>
                        <li><a  href="/ride" >Request</a></li>
                        <li><a  href="/drive" >Care Taker</a></li>
                        <li><a href="/cities">Cities</a></li>
                        <li><a  href="/fare_estimate">Fee Estimate<!-- /react-text --></a></li>
                        <li><a href="#">How it Works?<!-- /react-text --></a></li>
                        </ul>
                    </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <li ><a href="#" ><!-- react-text: 593 -->About<!-- /react-text --></a></li>
