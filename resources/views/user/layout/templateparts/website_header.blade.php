<header>
            ...
            <div class="row">
                <div class="col-md-2 right-padding">
                    <div class="logo" style="margin-top: 5px;margin-bottom: 5px;">
                        <a href="{{ url('/') }}"><img src="{{ asset('tuam_logo.jpg') }}" Style="width: 84px;" /></a>
                    </div>
            </div>
                ...
                <div class="col-md-5 help">
                    <div class="right">
                        ...
                        <!-- <div class="driver-btn hidden-xs">
                         <a href="{{ url('/provider/register') }}" class="btn btn-default" style="width: 160px;">Become Caretaker</a>
                        </div> -->
            ...
            <div class="container">
                ...
                <li><img src="{{asset('img/appstore.png')}}" width="50%" height="50%"></li>
                <li><a href="#">
                <img src="{{asset('img/playstore.png')}}" width="50%" height="50%"></a></li>
            </ul>
                </div>
                </div>
                    </div>
                ...
                <li><a href="#">
                    ...
                    <div class="eats">
                        <div class="container">
                            <h3>Support</h3>
                    <ul>
                        <li><a href="{{ url('/support') }}">Email Support</a></li>
                        <li><a href="{{ url('/support') }}">Phone Support</a></li>
                        <li><a href="{{ url('/support') }}">Live Support</a></li>
                    </ul>
                        </div>
                </div>
                    <div class="delhi-eng">
