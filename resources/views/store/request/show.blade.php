...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h4>Details</h4>
             <hr>
            <a href="{{ route('store.requests.index') }}" class="btn btn-default pull-right">
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        @else
                        <dd class="col-sm-8">Store not yet Accepted!</dd>
                        @endif

                        <!--<dt class="col-sm-4">Total Hour :</dt>
                        <dd class="col-sm-8">{{ $request->distance ? $request->distance : '-' }}</dd>-->

                        @if($request->status == 'SCHEDULED')
                        <dt class="col-sm-4">Care Scheduled Time :</dt>
                        <dd class="col-sm-8">
                        ...
                        <dt class="col-sm-4">Deliverd Time :</dt>
                        <dd class="col-sm-8">
