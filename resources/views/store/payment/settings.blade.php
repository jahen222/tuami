...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <form action="{{route('store.settings.payment.store')}}" method="POST">
                {{csrf_field()}}
                <h5>Payment Modes</h5>
                ...
                <div class="card card-block card-inverse card-info">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="form-group row">
                            <label for="driver_base_price" class="col-xs-4 col-form-label">Driver Base price</label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                                    value="{{ Setting::get('driver_base_price', '0')  }}"
                                    id="driver_base_price"
                                    name="driver_base_price"
                                    min="0"
                                    max="100"
                                    placeholder="Driver base price Percentage">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fare_price" class="col-xs-4 col-form-label">Face Price</label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                                    value="{{ Setting::get('fare_price', '0')  }}"
                                    id="fare_price"
                                    name="fare_price"
                                    min="0"
                                    max="100"
