...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('store.selling.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        @if(isset($service->item_image))
                        <img style="height: 90px; margin-bottom: 15px; border-radius:2em;" src="{{ img($service->item_image) }}">
                        @endif
