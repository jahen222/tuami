<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			...
			<li>
				<a href="{{ route('store.dashboard') }}" class="waves-effect waves-light">
...
<!-- 
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">Renenue</span>
				</a>
				<ul>
					<li><a href="{{ route('store.statement') }}">Order Revenue</a></li>
                    <li><a href="{{ route('store.payment') }}">Order History</a></li>
					<li><a href="{{ route('store.statement.provider') }}">Store Earning</a></li>
					<li><a href="{{ route('store.statement.today') }}">Daily Revenue</a></li>
					<li><a href="{{ route('store.statement.monthly') }}">Monthly Revenue</a></li>
					<li><a href="{{ route('store.statement.yearly') }}">Yearly Revenue</a></li>
				</ul>
			</li>
<!-- 
			<li>
			...
			<li>
				<a href="{{ route('store.requests.index') }}" class="waves-effect  waves-light">
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('store.selling.index') }}">Item List</a></li>
					<li><a href="{{ route('store.selling.create') }}">Add Item</a></li>
				</ul>
			</li>
			...
			<!-- <li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">Document</span>
				</a>
				<ul>
					<li><a href="">List</a></li>
