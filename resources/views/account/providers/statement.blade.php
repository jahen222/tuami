            	...
            	<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								...
								<i class="fa fa-caret-up text-success mr-0-5"></i><span>from {{$rides->count()}} Requests</span>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Cancelled Requests</h6>
															...
															<tr>
																...
																<td>
																	@if($ride->status != "CANCELLED")
																		<a class="text-primary" href="{{route('account.requests.show',$ride->id)}}"><span class="underline">View</span></a>
																	@else
