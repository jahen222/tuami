    ...
    <div class="row row-md">
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Total No. of Requests</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					...
					<i class="fa fa-caret-up text-success mr-0-5"></i><span>from {{$rides->count() }} <?php echo ( count( $rides->count() > 1 ) ) ? 'Requests' : 'Request';  ?></span>
				</div>
			</div>
		</div>
		<div class="col-lg-3 col-md-6 col-xs-12">
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Total Cancelled Requests</h6>
					<h1 class="mb-1">{{$cancel_rides}}</h1>
					<i class="fa fa-caret-down text-danger mr-0-5"></i><span>for @if($cancel_rides == 0) 0.00 @else {{round($cancel_rides/$rides->count(),2)}}% @endif Requests</span>
				</div>
			</div>
		</div>
		<div class="col-lg-3 col-md-6 col-xs-12">
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">No. of Providers</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				<div class="t-icon right"><span class="bg-success"></span><i class="ti-bar-chart"></i></div>
				<div class="t-content">
					<h6 class="text-uppercase mb-1">No. of Scheduled Requests</h6>
		...
		<div class="col-md-12">
				<div class="box bg-white">
					<div class="box-block clearfix">
						<h5 class="float-xs-left">Recent Requests</h5>
