...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <h5 style="margin-bottom: 2em;">Add Store</h5>
 ...
 <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
     ...
     {{ csrf_field() }}
               	...
               	<div class="form-group row">               		
                 	...
                 	<div class="col-xs-10">
					  	<select class="form-control" id="sel1"  name="provider_name" >
...
<!--  <div class="form-group" id="carif">-->
<!--                 <div class="col-xs-10">-->
<!--  <label for="sel1">Select sub categories:</label>-->
<!--  <select class="form-control" id="select" onchange="subService(this);" name="levelTwo"> -->
...
<!-- <input type="submit" name="g" value="Submit" id="g"> -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('name') }}" name="name"  id="name" placeholder="Service Name">
                    </div>
                </div>
 ...
 <div class="form-group row">
                    <label for="first_name" class="col-xs-12 col-form-label">Address </label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('location') }}" id="origin-input" required name="location"  placeholder="Enter Location">
                        <figure style="position: absolute;top: 12%;left: 95%;">
                            <img src="https://www.wedrive.ch/img/location_input.png" alt="img"/>
                        </figure>
                    </div>
                <div class="col-md-8">
                    ...
                    <div class="col-xs-10">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                                <button type="submit" class="btn btn-primary btn-block">Add Store</button>
