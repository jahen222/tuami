...
@section('title', 'Update Ambulance Provider ')
...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">Update Ambulance Provider</h5>
            ...
            <form class="form-horizontal" action="{{route('admin.fleet.update', $fleet->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="name" class="col-xs-2 col-form-label">Contact Person Name</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">Update Ambulance Provider</button>
