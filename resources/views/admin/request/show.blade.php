            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        @else
                        <dt class="col-sm-4">Care Start Time :</dt>
                        <dd class="col-sm-8">
                        ...
                        <dt class="col-sm-4">Care End Time :</dt>
                        <dd class="col-sm-8">
                        ...
                        <dt class="col-sm-4">Provider Address :</dt>
                        ...
                        <dt class="col-sm-4">Care Status : </dt>
                        <dd class="col-sm-8">
                            {{ $request->status }}
                        </dd>
