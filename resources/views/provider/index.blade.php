    ...
    <div class="row row-md">
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white">
                ...
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Today Request</h4>
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white">
                ...
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Completed Request</h4>
     ...
     <div class="row row-md">
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white">
                <!--div class="t-icon right"><span class="bg-danger"></span><i class="ti-rocket"></i></div-->
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Request Accepted</h4>
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white">
                <!--div class="t-icon right"><span class="bg-primary"></span><i class="ti-view-grid"></i></div-->
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Scheduled Request</h4>
